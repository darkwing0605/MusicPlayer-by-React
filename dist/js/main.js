...
var Main = React.createClass({
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(_progress2.default, { progress: this.state.progress, audioURL: this.state.audioURL })
		);
	}
});
...
// 获取音乐列表
var audioData = __webpack_require__(9);
audioData = function getAudioURL(audioDataArr) {
	for (var i in audioDataArr) {
		var singleAudioData = audioDataArr[i];

		singleAudioData.audioURL = __webpack_require__(10)("./" + singleAudioData.filename);

		singleAudioData[i] = singleAudioData;
	}
	return audioDataArr;
}(audioData);
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement('source', { src: this.props.audioURL, type: 'audio/mp3' }),
				'\u60A8\u7684\u6D4F\u89C8\u5668\u4E0D\u652F\u6301 audio \u6807\u7B7E\u3002'
			),
			this.props.progress,
			's'
...
module.exports = [{"filename":"布谷鸟.mp3"}]
